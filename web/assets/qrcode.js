...
(function e(t, n, r) {
	...
	2: [function (require, module, exports) {
		...
		QRCodeDraw.prototype = {
			...
			draw: function (canvas, text, options, cb) {
				...
				this.QRVersion(
					text, options.errorCorrectLevel || this.QRErrorCorrectLevel.H, options.version,
					function (e, t, l, ec) {
	...
	6: [function (require, module, exports) {
		...
		var out = [],
			...
			unmask = [
				0x00, 0x01, 0x02 | 0x01, 0x04 | 0x02 | 0x01, 0x08 | 0x04 | 0x02 | 0x01, 0x10 | 0x08 | 0x04 | 0x02 | 0x01, 0x20 | 0x10 | 0x08 | 0x04 | 0x02 | 0x01, 0x40 | 0x20 | 0x10 | 0x08 | 0x04 | 0x02 | 0x01
			]
	...
	7: [function (require, module, exports) {
		...
		function fast_copy(source, target, target_start, source_start, source_end) {
			...
			for (var i = target_start, j = source_start; i < len;
				++i,
				++j) {
				target[i] = source[j]
			}
